...
ArchiveURL := "http://mathieudutour.altervista.org/Polyhedral/index.html",
...
CommunicatedBy := "Mathieu Dutour Sikiric (Institut Rudjer Boskovic)",
# format: mm/yyyy
# AcceptDate := "08/1999",
AcceptDate := "08/1066",
...
##
README_URL := "http://mathieudutour.altervista.org/Polyhedral/index.html",
PackageInfoURL := "http://mathieudutour.altervista.org/Polyhedral/index.html",
...
Dependencies := rec(
  ...
  # ["gapcommon", ">= 0.0"], 
  NeededOtherPackages := [ ],
#  NeededOtherPackages := [ ["grape", ">= 4.2"], ["caratinterface", ">= 2.1.4"], ["images", ">= 1.3.0"], ["cryst", ">= 4.1.0"]],
  NeededOtherPackages := [ ["grape", ">= 4.2"], ["caratinterface", ">= 2.1.4"], ["hap", ">= 1.8.2"], ["images", ">= 1.3.0"], ["cryst", ">= 4.1.0"] ],
...
"lpcddcleaner", "Nudify"];
    ...
    do
      Info(InfoWarning, 1, "Package `MyPolyhedral': ", eFile, " is missing");
    od;
    if Length(ListMiss)>0 then
      Info(InfoWarning, 1, "Package `MyPolyhedral': binaries missing");
      Info(InfoWarning, 1, "Package `MyPolyhedral': some functions will not work");
    fi;
    return true;
  end,
