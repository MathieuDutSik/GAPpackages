...
ArchiveURL := "http://mathieudutour.altervista.org/GapCommon",
...
##
README_URL := "http://mathieudutour.altervista.org/GapCommon/index.html",
PackageInfoURL := "http://mathieudutour.altervista.org/GapCommon/PackageInfo.g",
...
##
AbstractHTML := "<span class=\"pkgname\">GapCommon</span> is a package for \
...
PackageWWWHome := "http://mathieudutour.altervista.org/GapCommon/",
...
BannerString :=
"\nLoading  GapCommon 0.8 (Planar Graph),\n\
by Mathieu.Dutour@gmail.com\n\n",

Subtitle := "Basic functions for GAP",
