...
##
AbstractHTML := "<span class=\"pkgname\">poset</span> is a package for \
handling partially ordered sets \
the class of posets, for which it is intended to is the geometrical posets.",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [["plangraph", ">= 0.8"], ["grape", ">= 4.2"]],
...
Subtitle := "polyhedral, polytopes, etc.",
