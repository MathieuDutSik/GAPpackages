#############################################################################
##
##  PackageInfo.g for the package `poset'                   Mathieu Dutour
##

SetPackageInfo( rec(

##  This is case sensitive, use your preferred spelling.
PackageName := "addipolyhedral",
...
##
AbstractHTML := "<span class=\"pkgname\">addipolyhedral</span> is a package of additional functions for dealing with polyhedral.",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [["MyPolyhedral", ">= 1.0"], ["grape", ">= 4.2"]],
